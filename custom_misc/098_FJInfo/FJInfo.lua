...
function SMODS.INIT.FJInfo()
    for _, t in ipairs(Fusables) do
        local n1 = (SMODS.Jokers[t[1]] and SMODS.Jokers[t[1]].loc_txt and SMODS.Jokers[t[1]].loc_txt.name) or
        localize { type = 'name_text', key = t[1], set = 'Joker' }
        local n2 = (SMODS.Jokers[t[2]] and SMODS.Jokers[t[2]].loc_txt and SMODS.Jokers[t[2]].loc_txt.name) or
        localize { type = 'name_text', key = t[2], set = 'Joker' }
        G.localization.descriptions.Other['fji_' .. t[1]] = {
            name = "_",
            text = { '{s:1.2,E:1,C:dark_edition}' .. n1 .. '{}' }
        }
        G.localization.descriptions.Other['fji_' .. t[2]] = {
            name = "_",
